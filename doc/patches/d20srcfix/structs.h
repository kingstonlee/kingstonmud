...
#define ARTISAN_TYPE_ARMORTECH  1
#define ARTISAN_TYPE_WEAPONTECH 2
#define ARTISAN_TYPE_TINKERING  3
#define ARTISAN_TYPE_ROBOTICS   4
#define ARTISAN_TYPE_SMITH      5
#define ARTISAN_TYPE_FARMER     6
#define ARTISAN_TYPE_WOODSMAN   7
